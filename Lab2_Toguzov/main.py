...
# @returns Инициализированный интерфейс
    def initUI(self):
        ...
        # Начальное время
        self.leDownBorder = tkinter.Entry(
            self,  width=75
        )
        ...
        self.leFourierMerge = tkinter.Entry(
            self, width=75
        )
        ...
        self.btnLocalSignal = tkinter.Button(
        ...
        self.btnCompileSignal = tkinter.Button(
            self,
        ...
        self.btnFourier = tkinter.Button(
        ...
        self.btnFourierMerge = tkinter.Button(
        ...
        # Разделить сигналы
        self.btnSeparate = tkinter.Button(
        ...
        is_split = tkinter.BooleanVar()
        self.chbxSplit = tkinter.Checkbutton(self, text="Import split signals?", variable = is_split)
